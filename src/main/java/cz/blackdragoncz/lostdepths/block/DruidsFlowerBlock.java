...
public class DruidsFlowerBlock extends FlowerBlock {
	public DruidsFlowerBlock() {
		super(() -> MobEffects.DARKNESS, 5000, BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).sound(SoundType.GRASS).instabreak().lightLevel(s -> 3).noCollission().offsetType(BlockBehaviour.OffsetType.XZ).pushReaction(PushReaction.DESTROY));
	}
