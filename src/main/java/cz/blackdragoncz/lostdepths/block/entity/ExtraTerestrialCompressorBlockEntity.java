...
public class ExtraTerestrialCompressorBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(2, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public ExtraTerestrialCompressorBlockEntity(BlockPos position, BlockState state) {
		super(LostdepthsModBlockEntities.EXTRA_TERESTRIAL_COMPRESSOR.get(), position, state);
	}
