...
public class ModuleCreatorBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public ModuleCreatorBlockEntity(BlockPos position, BlockState state) {
		super(LostdepthsModBlockEntities.MODULE_CREATOR.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("module_creator");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new ModuleCreatorGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
