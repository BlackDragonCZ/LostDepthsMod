...
public class MetaCollectorBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public MetaCollectorBlockEntity(BlockPos position, BlockState state) {
		super(LostdepthsModBlockEntities.META_COLLECTOR.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("meta_collector");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Meta Collector");
	}
