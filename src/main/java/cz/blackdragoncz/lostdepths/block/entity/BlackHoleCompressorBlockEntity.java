...
public class BlackHoleCompressorBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(2, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BlackHoleCompressorBlockEntity(BlockPos position, BlockState state) {
		super(LostdepthsModBlockEntities.BLACK_HOLE_COMPRESSOR.get(), position, state);
	}
	...
	private final EnergyStorage energyStorage = new EnergyStorage(2000000, 25000, 1000000, 0) {
		@Override
