...
/*
public abstract class AbstractElectricBlock extends BaseEntityBlock {

    protected AbstractElectricBlock() {
        super(BlockBehaviour.Properties.of().sound(SoundType.METAL).strength(4f, 16f).pushReaction(PushReaction.BLOCK));
    }

    public static final int BASE_TICKS = 10;
    ...
    public @NotNull List<ItemStack> getDrops(@NotNull BlockState state, LootParams.@NotNull Builder builder) {
        List<ItemStack> dropsOriginal = super.getExpDrop(state, builder);
        ...
        if (entity instanceof ServerPlayer player) {
            NetworkHooks.openScreen(player, new MenuProvider() {
                ...
                public @NotNull Component getDisplayName() {
                    return AbstractElectricBlock.this.getDisplayName();
                }
