...
import cz.blackdragoncz.lostdepths.procedures.CelestialLogsRedBlockDestroyedByPlayerProcedure;

public class CelestialLogsRedBlock extends Block {
	public static final EnumProperty<Direction.Axis> AXIS = BlockStateProperties.AXIS;

	public CelestialLogsRedBlock() {
	...
	public boolean onDestroyedByPlayer(BlockState blockstate, Level world, BlockPos pos, Player entity, boolean willHarvest, FluidState fluid) {
		...
		CelestialLogsRedBlockDestroyedByPlayerProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), entity);
		return retval;
	}
}
