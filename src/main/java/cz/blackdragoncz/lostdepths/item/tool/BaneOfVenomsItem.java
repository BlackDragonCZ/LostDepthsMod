...
import cz.blackdragoncz.lostdepths.procedures.BaneOfVenomsLivingEntityIsHitWithToolProcedure;

public class BaneOfVenomsItem extends SwordItem {
	public BaneOfVenomsItem() {
		super(new Tier() {
			public int getUses() {
				return 0;
			}
