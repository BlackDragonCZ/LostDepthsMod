...
public class CrystalizerGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CrystalizerGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LostdepthsModMenus.CRYSTALIZER_GUI.get(), id);
