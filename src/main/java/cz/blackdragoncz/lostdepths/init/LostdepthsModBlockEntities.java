...
public class LostdepthsModBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<NurostarBatteryBlockEntity>> NUROSTAR_BATTERY = register("nurostar_battery", LostdepthsModBlocks.NUROSTAR_BATTERY, NurostarBatteryBlockEntity::new);
	public static final RegistryObject<BlockEntityType<NurostarBatteryBlockEntity>> NUROSTAR_LARGE_BATTERY = REGISTRY.register("nurostar_large_battery", () -> BlockEntityType.Builder.of(NurostarBatteryBlockEntity::createLarge, LostdepthsModBlocks.NUROSTAR_LARGE_BATTERY.get()).build(null));
	...
	public static final RegistryObject<BlockEntityType<cz.blackdragoncz.lostdepths.block.creative.entity.RealityDisruptorBlockEntity>> REALITY_DISRUPTOR = register("reality_disruptor", LostdepthsModBlocks.REALITY_DISRUPTOR, cz.blackdragoncz.lostdepths.block.creative.entity.RealityDisruptorBlockEntity::new);
	public static final RegistryObject<BlockEntityType<cz.blackdragoncz.lostdepths.block.creative.entity.GravatorDisruptorBlockEntity>> GRAVATOR_DISRUPTOR = register("gravator_disruptor", LostdepthsModBlocks.GRAVATOR_DISRUPTOR, cz.blackdragoncz.lostdepths.block.creative.entity.GravatorDisruptorBlockEntity::new);
	...
	public static final RegistryObject<BlockEntityType<NTCraftingTerminalBlockEntity>> NT_CRAFTING_TERMINAL = register("nt_crafting_terminal", LostdepthsModBlocks.NT_CRAFTING_TERMINAL, NTCraftingTerminalBlockEntity::new);
	public static final RegistryObject<BlockEntityType<NTDriveBlockEntity>> NT_DRIVE = REGISTRY.register("nt_drive", () -> BlockEntityType.Builder.of((pos, state) -> new NTDriveBlockEntity(pos, state, 3), LostdepthsModBlocks.NT_DRIVE.get()).build(null));
	public static final RegistryObject<BlockEntityType<NTDriveBlockEntity>> NT_DRIVE_T2 = REGISTRY.register("nt_drive_t2", () -> BlockEntityType.Builder.of(NTDriveBlockEntity::createTier2, LostdepthsModBlocks.NT_DRIVE_T2.get()).build(null));
	...
	public static final RegistryObject<BlockEntityType<NTBridgeRSBlockEntity>> NT_BRIDGE_RS = register("nt_bridge_rs", LostdepthsModBlocks.NT_BRIDGE_RS, NTBridgeRSBlockEntity::new);
