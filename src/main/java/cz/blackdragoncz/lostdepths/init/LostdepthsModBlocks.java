...
public class LostdepthsModBlocks {
	...
	public static final RegistryObject<Block> INFUSED_IRON_BRICKS = REGISTRY.register("infused_iron_bricks", InfusedIronBricksBlock::new);
	public static final RegistryObject<Block> INFUSED_IRON_PILLAR = REGISTRY.register("infused_iron_pillar", InfusedIronPillarBlock::new);
	public static final RegistryObject<Block> INFUSED_IRON_BRICK_STAIRS = REGISTRY.register("infused_iron_brick_stairs", InfusedIronBrickStairsBlock::new);
	public static final RegistryObject<Block> INFUSED_IRON_BRICK_SLAB = REGISTRY.register("infused_iron_brick_slab", InfusedIronBrickSlabBlock::new);
	public static final RegistryObject<Block> SPACE_ROCK = REGISTRY.register("space_rock", SpaceRockBlock::new);
	public static final RegistryObject<Block> SPACE_ROCK_DIRT = REGISTRY.register("space_rock_dirt", SpaceRockDirtBlock::new);
	public static final RegistryObject<Block> FERRO_LOG = REGISTRY.register("ferro_log", FerroLogBlock::new);
	public static final RegistryObject<Block> FERRO_LEAVES = REGISTRY.register("ferro_leaves", FerroLeavesBlock::new);
	public static final RegistryObject<Block> FIRERITE_ORE = REGISTRY.register("firerite_ore", FireriteOreBlock::new);
	public static final RegistryObject<Block> MELWORIUM_ORE = REGISTRY.register("melworium_ore", MelworiumOreBlock::new);
	public static final RegistryObject<Block> MORFARITE_ORE = REGISTRY.register("morfarite_ore", MorfariteOreBlock::new);
	public static final RegistryObject<Block> FACTORY_BLOCK = REGISTRY.register("factory_block", FactoryBlockBlock::new);
	public static final RegistryObject<Block> SHIPMENT_FILLER_BLOCK = REGISTRY.register("shipment_filler_block", ShipmentFillerBlock::new);
	public static final RegistryObject<Block> ITEM_CRATE = REGISTRY.register("item_crate", ItemCrateBlock::new);
	public static final RegistryObject<Block> O_FACTORY_BLOCK = REGISTRY.register("o_factory_block", OFactoryBlockBlock::new);
	public static final RegistryObject<Block> COSMIC_CARPET = REGISTRY.register("cosmic_carpet", CosmicCarpetBlock::new);
	...
	public static final RegistryObject<Block> GALACTIC_COMPRESSOR = REGISTRY.register("galactic_compressor", GalacticCompressorBlock::new);
	public static final RegistryObject<Block> DRUIDS_FLOWER = REGISTRY.register("druids_flower", DruidsFlowerBlock::new);
	public static final RegistryObject<Block> QUANTUM_TRANSPORTER = REGISTRY.register("quantum_transporter", QuantumTransporterBlock::new);
	public static final RegistryObject<Block> INFUSEDIRON_PILLAR_CROSS = REGISTRY.register("infusediron_pillar_cross", InfusedironPillarCrossBlock::new);
	public static final RegistryObject<Block> INFUSED_IRON_CROSS_GLOW = REGISTRY.register("infused_iron_cross_glow", InfusedIronCrossGlowBlock::new);
	public static final RegistryObject<Block> NEO_GLASS = REGISTRY.register("neo_glass", NeoGlassBlock::new);
	public static final RegistryObject<Block> ALLOY_WORKSTATION = REGISTRY.register("workstation_2", AlloyWorkstationBlock::new);
	...
	public static final RegistryObject<Block> JAMMER_A = REGISTRY.register("jammer_a", JammerABlock::new);
	public static final RegistryObject<Block> JAMMER_B = REGISTRY.register("jammer_b", JammerBBlock::new);
	public static final RegistryObject<Block> JAMMER_C = REGISTRY.register("jammer_c", JammerCBlock::new);
	public static final RegistryObject<Block> JAMMER_D = REGISTRY.register("jammer_d", JammerDBlock::new);
	public static final RegistryObject<Block> NITRO_LOG = REGISTRY.register("nitro_log", NitroLogBlock::new);
	public static final RegistryObject<Block> CHEM_TECH = REGISTRY.register("chem_tech", ChemTechBlock::new);
	public static final RegistryObject<Block> JAMMER_ACCESS_MODULE = REGISTRY.register("jammer_access_module", JammerAccessModuleBlock::new);
	public static final RegistryObject<Block> JAMMER_GATE = REGISTRY.register("jammer_gate", JammerGateBlock::new);
	public static final RegistryObject<Block> JAMMER_GATE_OFF = REGISTRY.register("jammer_gate_off", JammerGateOffBlock::new);
	...
	public static final RegistryObject<Block> TREASURE_NEO_SLAB_BLOCK = REGISTRY.register("treasure_neo_slab_block", TreasureNeoSlabBlockBlock::new);
	...
	public static final RegistryObject<Block> TERMINAL_MONITOR = REGISTRY.register("terminal_monitor", TerminalMonitorBlock::new);
	public static final RegistryObject<Block> TERMINAL_CONSOLE_1 = REGISTRY.register("terminal_console_1", TerminalConsole1Block::new);
	public static final RegistryObject<Block> TERMINAL_CONSOLE_2 = REGISTRY.register("terminal_console_2", TerminalConsole2Block::new);
	public static final RegistryObject<Block> TERMINAL_CONSOLE_3 = REGISTRY.register("terminal_console_3", TerminalConsole3Block::new);
	public static final RegistryObject<Block> STAR_CHEST = REGISTRY.register("star_chest", StarChestBlock::new);
	public static final RegistryObject<Block> STAR_CHEST_OPEN = REGISTRY.register("star_chest_open", StarChestOpenBlock::new);
	public static final RegistryObject<Block> DRACONIC_CHEST_OPEN = REGISTRY.register("draconic_chest_open", DraconicChestOpenBlock::new);
	...
	public static final RegistryObject<Block> DRACONIC_FLAG = REGISTRY.register("draconic_flag", DraconicFlagBlock::new);
	public static final RegistryObject<Block> ULTRA_RESISTIVE_GLASS = REGISTRY.register("ultra_resistive_glass", UltraResistiveGlassBlock::new);
	public static final RegistryObject<Block> MYRITE_ORE = REGISTRY.register("myrite_ore", MyriteOreBlock::new);
	public static final RegistryObject<Block> MYRITE_ORE_ACTIVE = REGISTRY.register("myrite_ore_active", MyriteOreActiveBlock::new);
	public static final RegistryObject<Block> LUCIENT_ORE = REGISTRY.register("lucient_ore", LucientOreBlock::new);
	public static final RegistryObject<Block> LUCIENT_ORE_ACTIVE = REGISTRY.register("lucient_ore_active", LucientOreActiveBlock::new);
	public static final RegistryObject<Block> HYPERIUM_ORE = REGISTRY.register("hyperium_ore", HyperiumOreBlock::new);
	public static final RegistryObject<Block> PSYCHERIUM_ORE = REGISTRY.register("psycherium_ore", PsycheriumOreBlock::new);
	public static final RegistryObject<Block> VARLLERIUM_ORE = REGISTRY.register("varllerium_ore", VarlleriumOreBlock::new);
	public static final RegistryObject<Block> BIOLLITERITE_ORE = REGISTRY.register("biolliterite_ore", BiolliteriteOreBlock::new);
	public static final RegistryObject<Block> NECROTONITE_ORE = REGISTRY.register("necrotonite_ore", NecrotoniteOreBlock::new);
	public static final RegistryObject<Block> NOXHERTIUM_ORE = REGISTRY.register("noxhertium_ore", NoxhertiumOreBlock::new);
	public static final RegistryObject<Block> COGNITIUM_ORE = REGISTRY.register("cognitium_ore", CognitiumOreBlock::new);
	public static final RegistryObject<Block> MULTIVERSITE_ORE = REGISTRY.register("multiversite_ore", MultiversiteOreBlock::new);
	public static final RegistryObject<Block> PHOTOTENZYTE_ORE = REGISTRY.register("phototenzyte_ore", PhototenzyteOreBlock::new);
	public static final RegistryObject<Block> PHOTOTENZYTE_ORE_ACTIVE = REGISTRY.register("phototenzyte_ore_active", PhototenzyteOreActiveBlock::new);
	public static final RegistryObject<Block> DEEP_SPACE_ROCK = REGISTRY.register("deep_space_rock", DeepSpaceRockBlock::new);
	public static final RegistryObject<Block> FUNGAL_SPACE_ROCK = REGISTRY.register("fungal_space_rock", FungalSpaceRockBlock::new);
	public static final RegistryObject<Block> CELESTIAL_LOGS_BLUE = REGISTRY.register("celestial_logs_blue", CelestialLogsBlueBlock::new);
	public static final RegistryObject<Block> CELESTIAL_LOGS_RED = REGISTRY.register("celestial_logs_red", CelestialLogsRedBlock::new);
	public static final RegistryObject<Block> CELESTIAL_LEAVES_BLUE = REGISTRY.register("celestial_leaves_blue", CelestialLeavesBlueBlock::new);
	public static final RegistryObject<Block> CELESTIAL_LEAVES_RED = REGISTRY.register("celestial_leaves_red", CelestialLeavesRedBlock::new);
	public static final RegistryObject<Block> MODULATOR = REGISTRY.register("modulator", ModulatorBlock::new);
	public static final RegistryObject<Block> BLACK_HOLE_COMPRESSOR = REGISTRY.register("black_hole_compressor", BlackHoleCompressorBlock::new);
