...
public class LostdepthsModBlocks {
	...
	public static final RegistryObject<Block> SECURITY_CLEARANCE_GATE_1 = REGISTRY.register("security_clearance_1", () -> new SecurityClearanceBlock(1));
	public static final RegistryObject<Block> SECURITYCLEARANCEGATE_2 = REGISTRY.register("security_clearance_2", () -> new SecurityClearanceBlock(2));
	public static final RegistryObject<Block> SECURITY_CLEARANCE_3 = REGISTRY.register("security_clearance_3", () -> new SecurityClearanceBlock(3));
	...
	public static final RegistryObject<Block> SECURITY_CLEARANCE_4 = REGISTRY.register("security_clearance_4", () -> new SecurityClearanceBlock(4));
	...
	public static final RegistryObject<Block> LASER_GATE = REGISTRY.register("laser_gate", () -> new LaserGateBlock(1));
	public static final RegistryObject<Block> LASER_GATE_VERTICAL = REGISTRY.register("laser_gate_vertical", () -> new LaserGateBlock(1));
	...
	public static final RegistryObject<Block> LASER_GATE_2 = REGISTRY.register("laser_gate_2", () -> new LaserGateBlock(2));
	public static final RegistryObject<Block> LASER_GATE_3 = REGISTRY.register("laser_gate_3", () -> new LaserGateBlock(3));
	public static final RegistryObject<Block> LASER_GATE_4 = REGISTRY.register("laser_gate_4", () -> new LaserGateBlock(4));
	...
	public static final RegistryObject<Block> SECURITY_CLEARANCE_5 = REGISTRY.register("security_clearance_5", () -> new SecurityClearanceBlock(5));
	public static final RegistryObject<Block> SECURITY_CLEARANCE_6 = REGISTRY.register("security_clearance_6", () -> new SecurityClearanceBlock(6));
	public static final RegistryObject<Block> LASER_GATE_5 = REGISTRY.register("laser_gate_5", () -> new LaserGateBlock(5));
	public static final RegistryObject<Block> LASER_GATE_6 = REGISTRY.register("laser_gate_6", () -> new LaserGateBlock(6));
	...
	public static final RegistryObject<Block> SECURITY_CLEARANCE_A = REGISTRY.register("security_clearance_a", CreativeStaticBlock::new);
}
