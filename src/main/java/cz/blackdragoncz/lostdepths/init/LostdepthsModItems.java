...
public class LostdepthsModItems {
	...
	public static final RegistryObject<Item> SECURITY_PASS_1 = REGISTRY.register("security_pass_1", SecurityPass1Item::new);
	public static final RegistryObject<Item> SECURITY_PASS_2 = REGISTRY.register("security_pass_2", SecurityPass2Item::new);
	public static final RegistryObject<Item> SECURITY_PASS_3 = REGISTRY.register("security_pass_3", SecurityPass3Item::new);
