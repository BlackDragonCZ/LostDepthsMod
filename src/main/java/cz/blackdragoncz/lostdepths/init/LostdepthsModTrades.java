	...
	public static void registerTrades(VillagerTradesEvent event) {
		if (event.getType() == LostdepthsModVillagerProfessions.COSMIC_SCIENTIST.get()) {
			event.getTrades().get(1)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.INFUSED_IRON.get(), 2),

					new ItemStack(LostdepthsModItems.SOLARIUM_SKY.get()), 1024, 1, 0.05f));
			event.getTrades().get(1)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.SOLARIUM_SKY.get(), 8),
			...
			event.getTrades().get(2)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.SOLARIUM_SKY.get(), 24), new ItemStack(Items.PRISMARINE_CRYSTALS, 4), new ItemStack(LostdepthsModItems.ENRICHED_PRISMARINE.get()), 1024, 5, 0.05f));
			...
			event.getTrades().get(3)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.SOLARIUM_SKY.get(), 8), new ItemStack(Blocks.BONE_BLOCK, 2), new ItemStack(LostdepthsModItems.HARDENED_CALCIUM.get(), 2), 1024, 5, 0.05f));
			...
			event.getTrades().get(5)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.SOLARIUM_SKY.get(), 12), new ItemStack(Items.ENDER_EYE, 5), new ItemStack(LostdepthsModItems.HYPNOTIC_EYE.get()), 1024, 5, 0.05f));
		}
		if (event.getType() == LostdepthsModVillagerProfessions.ATMOSPHERIC_SCIENTIST.get()) {
			...
			event.getTrades().get(1)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.SOLARIUM_CORE.get(), 2),

					new ItemStack(LostdepthsModItems.GRAVITY_DUST.get()), 1024, 5, 0.05f));
			event.getTrades().get(2)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.SOLARIUM_CORE.get(), 2), new ItemStack(Items.AMETHYST_SHARD), new ItemStack(LostdepthsModItems.CYCLONE_DUST.get()), 1024, 5, 0.05f));
			event.getTrades().get(2)
			...
			event.getTrades().get(4)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.IRON_GOLEM_ESSENCE.get()),
			...
			event.getTrades().get(5)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.EXTERNAL_CLOVINITE_BATTERY.get(), 10), new ItemStack(LostdepthsModItems.ELECTRON_RECYCLER.get(), 5),new ItemStack(LostdepthsModItems.CLOVINITE_POWER_HUB.get()), 1024, 5, 0.05f));
			event.getTrades().get(5)
		...
		if (event.getType() == LostdepthsModVillagerProfessions.BLACK_MARKET_SELLER.get()) {
			event.getTrades().get(1)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.JAR_OF_SYRUP.get(), 12),
			...
			event.getTrades().get(2)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.SOLARIUM_HUNTER.get(), 50), new ItemStack(LostdepthsModItems.SOLARIUM_CORE.get(), 50), new ItemStack(LostdepthsModItems.GEM_RESOLVE.get()), 2, 5, 0.05f));
			event.getTrades().get(2)
			...
			event.getTrades().get(3)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.SOLARIUM_HUNTER.get(), 20), new ItemStack(Items.GOLD_INGOT), new ItemStack(LostdepthsModItems.INFUSED_GOLD.get()), 1024, 5, 0.05f));
			event.getTrades().get(4)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.SOLARIUM_HUNTER.get(), 50), new ItemStack(LostdepthsModItems.ENDER_VOLTAIC_SOLUTION.get(), 16), new ItemStack(LostdepthsModItems.GEM_DREAD.get()), 1024, 5, 0.05f));
		}
		if (event.getType() == LostdepthsModVillagerProfessions.CHEMISTRY_OPERATOR.get()) {
			event.getTrades().get(1)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.REINFORCED_BOTTLE.get(), 3),

					new ItemStack(LostdepthsModItems.SOLARIUM_TOXIC.get(), 2), 1024, 5, 0.05f));
			event.getTrades().get(1)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.SOLARIUM_TOXIC.get(), 25),
			...
			event.getTrades().get(2)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.SOLARIUM_TOXIC.get(), 25), new ItemStack(LostdepthsModItems.INFUSED_IRON.get(), 2), new ItemStack(LostdepthsModItems.GLOWING_SAC.get()), 1024, 5, 0.05f));
			event.getTrades().get(3)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.SOLARIUM_TOXIC.get(), 35),

					new ItemStack(LostdepthsModItems.ACID_TONGUE.get()), 1024, 5, 0.05f));
			event.getTrades().get(3)
					.add(new BasicItemListing(new ItemStack(LostdepthsModItems.SOLARIUM_TOXIC.get(), 15),
