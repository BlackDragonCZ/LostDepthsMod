...
public class LostdepthsModModifiers {
    ...
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> ADVANCED_FORTUNE = REGISTRY.register("advanced_fortune", () -> AdvancedEnchantmentsLootModifiers.CODEC);
}
