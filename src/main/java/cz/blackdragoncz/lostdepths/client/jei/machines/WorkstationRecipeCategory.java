...
public class WorkstationRecipeCategory extends BaseRecipeCategory<LDShapedRecipe> {
    ...
    public WorkstationRecipeCategory(IGuiHelper helper, IRecipeViewerRecipeType<LDShapedRecipe> recipeType) {
