...
public class Modelthe_protector<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("lostdepths", "modelthe_protector"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 40).addBox(-9.0F, -2.0F, -6.0F, 18.0F, 12.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(0, 70).addBox(-4.5F, 10.0F, -3.0F, 9.0F, 5.0F, 6.0F, new CubeDeformation(0.5F)).texOffs(0, 0)
						.addBox(-1.0F, -6.0F, 5.0F, 2.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(108, 0).addBox(-5.0F, -25.0F, 5.0F, 10.0F, 21.0F, 0.0F, new CubeDeformation(0.0F)),
