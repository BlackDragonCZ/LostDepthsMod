...
import cz.blackdragoncz.lostdepths.client.gui.ILightingSettings;
import cz.blackdragoncz.lostdepths.client.gui.UIRenderHelper;
import cz.blackdragoncz.lostdepths.util.Color;
import cz.blackdragoncz.lostdepths.util.VecHelper;
            ...
            if (blockState.getBlock() == Blocks.AIR) {
                ...
                blockRenderer.getModelRenderer()
                        .renderModel(ms.last(), buffer.getBuffer(renderType), blockState, blockModel, 1, 1, 1,
                                LightTexture.FULL_BRIGHT, OverlayTexture.NO_OVERLAY, VIRTUAL_DATA, null);
            } else {
                ...
                for (RenderType chunkType : blockModel.getRenderTypes(blockState, RandomSource.create(42L), VIRTUAL_DATA)) {
                    ...
                    blockRenderer.getModelRenderer()
                            .renderModel(ms.last(), buffer.getBuffer(renderType), blockState, blockModel,
                                    ...
                                    LightTexture.FULL_BRIGHT, OverlayTexture.NO_OVERLAY, VIRTUAL_DATA, chunkType);
                }
            }
